        ...
        while True:
            ...
            for event in events:
                ...
                if FRONT_FLIPPER_MODE:
                    if event.ev_type == ecodes.EV_ABS and event.ev_code == ecodes.ABS_Y:
                    ...
                    elif event.ev_type == ecodes.EV_ABS and event.ev_code == ecodes.ABS_RY:
